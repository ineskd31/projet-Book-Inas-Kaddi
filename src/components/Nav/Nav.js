    ...
    return (
        <nav className='flex justify-between p-4 shadow-lg pl-10 pr-10'>
            ...
            <div id="drawer-navigation" className="fixed top-0 left-0 z-40 w-80 h-screen overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
                <div className='h-[6%] bg-slate-200 flex justify-start items-center pl-5 mb-5'>
                ...
                <div className="py-4 overflow-y-auto pl-5">
                    <div className="space-y-6 font-medium">
                        <p className='text-lg'>Bookshelf Minimal</p>
                        <p className='text-lg'>Bookshelf Modern</p>
                        <p className='text-lg'>Bookshelf Classic</p>
                        <p className='text-lg cursor-pointer'>All Books</p>
