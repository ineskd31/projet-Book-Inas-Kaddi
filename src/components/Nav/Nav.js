    ...
    return (
        <nav className='flex justify-between p-4 shadow-lg pl-10 pr-10'>
            ...
            <div className="text-center flex items-center">
                ...
                <p className='text-2xl'>BOOKSHELF.</p>
            </div>

            {/* <!-- drawer component --> */}
            <div id="drawer-navigation" className="fixed top-0 left-0 z-40 w-64 h-screen overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
                <div className='h-[5%] bg-slate-200 flex justify-start items-center'>
            ...
            <div className='flex items-center gap-4 bg-gray-100 p-3 w-[700px] rounded-lg focus-within:border-2 focus-within:border-black '>
                <BsSearch />
                <input className='bg-gray-100 pl-2 w-full outline-0' type="text" placeholder='Search your book here' />
            </div>
